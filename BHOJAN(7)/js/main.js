...
function displaySearchResult(location) {
    debugger;
    var xml = searchloadXMLDoc("xml/recipe.xml");
    var id = "searchres";

    var value = location;
    xsl = searchloadXMLDoc("xsl/Title.xsl");    
    document.getElementById(id).innerHTML = " ";
    ...
    if (window.ActiveXObject || xhttp.responseType == "msxml-document") {
        ...
        if (id == "north" || id == "south") {
            ...
            xsltProcessor.setParameter(null, "title", value);
        }
...
function searchloadXMLDoc(filename) {
    if (window.ActiveXObject) {
        xhttp = new ActiveXObject("Msxml1.XMLHTTP");
    } else {
        xhttp = new XMLHttpRequest();
    }
    xhttp.open("GET", filename, false);
...
$(function () {
    var availableTags = [
      "Aaloo Paratha", "Beetroot Raita", "Cauliflower Curry", "Cauliflower Paratha", "Chicken Tikka Masala", "Cucumber Raita", "Daal Fry", "Phodnicha Bhaat",
      "Jeera rice", "Kadhai Paneer", "Methi Paratha", "Palak Paneer", "Paneer butter Masala", "Pinapple Raita", "Potato curry", "Spinach Raita", "Moong Usal", "Methi Pakoras",
      "Chickpea Pulav", "Cheela", "Egg Bhurjee", "Anda Curry", "Anardana Raita", "Aloo Kurkure", "Achaari Paneer", "Date Nut Ladoo", "Sandesh", "Chocolate Peda",
      "Paneer Kheer", "Apple Kheer", "Choco Khoya Kalakand", "Mushroom Fry", "Besan Ka Cheela", "Beetroot Roti", "Pepper Chicken", "Coconut and Rice Kheer",
      "Caramelized Almonds", "Peach Almond Suji Halwa", "Coconut Barfi", "Badam Payasam", "Raspberry Coconut Balls", "Banana Sheera", "Badam Ladoo", "Carrot Kheer",
      "Semiya", "Rava Upma", "Palkova", "Instant Mango Pickle", "Onion Thokku", "Veg Khurma", "Rava Kesari", "Coconut Chutney", "Kaju Katli", "Besan Ladoo",
      "Bendakaya", "Rava Ladoo", "Coconut Ladoo"
    ];
    $("#search").autocomplete({
